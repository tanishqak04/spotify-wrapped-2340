...
public class EasterWrap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        api.getTopTracks10(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() -> Toast.makeText(EasterWrap.this, "Network error: " + e.getMessage(), Toast.LENGTH_SHORT).show());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (!response.isSuccessful()) {
                    runOnUiThread(() -> Toast.makeText(EasterWrap.this, "Error fetching top tracks: " + response.message(), Toast.LENGTH_SHORT).show());
                    return;
                }
                    ...
                    runOnUiThread(() -> {
                        try {
                            for (int i = 0; i < tracks.length() && i < imageViewIds.length; i++) {
                                ...
                                Glide.with(EasterWrap.this).load(imageUrl).into(imageView);
