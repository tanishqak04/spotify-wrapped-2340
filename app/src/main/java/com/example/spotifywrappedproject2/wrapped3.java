...
public class wrapped3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrapped3);
        ...
        try {
            ...
            Toast.makeText(wrapped3.this, "No data Available", Toast.LENGTH_SHORT).show();
        }
        ...
        if (receivedMap != null) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                Glide.with(wrapped3.this).load(urls.get(i)).into(album);
            }
        }
