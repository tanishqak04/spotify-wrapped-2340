...
public class wrapped2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrapped2);
        ...
        try {
            ...
            Toast.makeText(wrapped2.this, "No data Available", Toast.LENGTH_SHORT).show();
        }
        if (receivedMap != null) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                Glide.with(wrapped2.this).load(urls.get(i)).into(album);
            }
        }
