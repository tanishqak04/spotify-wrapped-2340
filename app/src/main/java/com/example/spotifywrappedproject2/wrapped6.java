...
public class wrapped6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrapped6);
        ...
        try {
            ...
            Toast.makeText(wrapped6.this, "No data Available", Toast.LENGTH_SHORT).show();
        }
        ...
        if (receivedMap != null) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                Glide.with(wrapped6.this).load(urls.get(i)).into(album);
            }
        }
